...
public class ThumbnailatorTest {
   ...
   thumbnailatorTest.test5();
     ...
     * watermark(位置，水印图，透明度)         */
        Thumbnails.of("D:\\J-USER\\desktop7\\test\\java.jpg").size(1280, 1024).watermark(Positions.BOTTOM_RIGHT, ImageIO.read(new File("D:\\J-USER\\Documents\\Pictures\\12.jpg")), 0.1f)
                .outputQuality(0.1f).toFile("D:\\J-USER\\desktop7\\test\\java2.jpg");
